...
export const generateQuizQuestions = async (
  count: number = 10,
  category: QuestionCategory = QuestionCategories.GENERAL
): Promise<Question[]> => {
  try {
    if (!API_KEY) {
...
const mockQuestions: Question[] = [
  ...
  {
    questionText:
      "أي من هذه الصحاري تقع بشكل رئيسي في المملكة العربية السعودية؟",
  ...
  {
    questionText:
      "أي برج من الأبراج التالية يقع في مدينة الرياض ويتميز بفتحة في أعلاه؟",
  ...
  {
    questionText:
      "ما هو الحيوان الذي يشتهر بقدرته على تحمل العطش في صحاري السعودية؟",
  ...
  {
    questionText:
      "ما هو المهرجان الوطني للتراث والثقافة الذي يقام سنوياً في الرياض؟",
    options: [
      "مهرجان ورد الطائف",
      "مهرجان الجنادرية",
      "سوق عكاظ",
  ...
  {
    questionText:
      "أي من المواقع التالية مدرج ضمن قائمة اليونسكو للتراث العالمي؟",
    options: [
      "شاطئ نصف القمر",
      "مدائن صالح (الحِجر)",
      "جبل طويق",
