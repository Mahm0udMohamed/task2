...
const Star: React.FC<{ style: React.CSSProperties }> = ({ style }) => (
    <div className="absolute bg-[#FEFDE0] rounded-full animate-twinkle" style={style}></div>
);
...
const App: React.FC = () => {
    ...
    return (
        <div className="relative min-h-screen bg-gradient-to-b from-[#232946] to-[#43417A] text-white flex flex-col items-center justify-center p-4 overflow-hidden selection:bg-[#EE9483] selection:text-white">
            ...
            <div className="absolute bottom-0 left-0 right-0 h-1/3 bg-[#D4A373] z-0" style={{ clipPath: 'ellipse(100% 60% at 50% 100%)' }}></div>
        </div>
    );
};
