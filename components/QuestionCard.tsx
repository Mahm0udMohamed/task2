    ...
    <div className="w-full flex flex-col h-full animate-fade-in-up">
      ...
      <div className="flex-grow flex items-center justify-center py-4">
        <h2
          ...
          style={{
            textShadow:
              "0 0 10px rgba(254, 253, 224, 0.5), 0 0 20px rgba(238, 148, 131, 0.5)",
          }}
        >
        ...
        {question.options.map((option) => {
          ...
          return (
            <button
              ...
              className={`flex items-center justify-between w-full text-lg font-bold p-4 rounded-full border transition-all duration-300 transform active:scale-95 focus:outline-none focus:ring-4 focus:ring-cyan-300/50 disabled:cursor-not-allowed disabled:transform-none ${getButtonClass(
                option
              )}`}
            >
              <span>{option}</span>
