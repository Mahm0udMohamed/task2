...
const StartScreen: React.FC<StartScreenProps> = ({ onStart }) => {
    ...
    return (
        <div className="relative text-center text-slate-800 flex flex-col items-center animate-fade-in z-20">
            ...
            <h1 className="text-5xl md:text-6xl font-black text-white drop-shadow-lg mb-2" style={{ textShadow: '4px 4px 0px #EE9483' }}>
                مغامرات المعرفة
            </h1>
            ...
            <div className="mb-6 w-full max-w-sm">
                 <p className="font-bold text-yellow-100/90 mb-3 text-xl">اختر نوع الأسئلة:</p>
            ...
            <div className="mb-8 w-full max-w-sm">
                <p className="font-bold text-yellow-100/90 mb-3 text-xl">اختر عدد الأسئلة:</p>
